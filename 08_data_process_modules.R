.checkParamsOld = function(raw, processout, normalization, fillIncompleteRows,
...
.checkDataOld = function(raw, processout, finalfile) {
...
.reformatOld = function(raw.temp, processout, finalfile) {
...
.fractionsOld = function(work, checkMultirun, processout, finalfile) {
...
.normalizeOld = function(work, normalization, nameStandards, processout, finalfile) {
...
.selectFeaturesOld = function(work, processout, featureSubset, n_top_feature, finalfile) {
